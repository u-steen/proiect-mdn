...
function Homepage() {
  ...
  return (
    <div className="bg-blue-600 h-screen w-screen flex justify-center">
      ...
      {showMainMenu && (
        <div className="absolute top-1/2 left-1/2 bg-green-600 p-3 rounded transform -translate-x-1/2 -translate-y-1/2 text-center" id="mainMenu">
      ...
      {showSubMenu && (
        <div className="absolute top-1/2 left-1/2 bg-green-600 p-3 rounded transform -translate-x-1/2 -translate-y-1/2 text-center" id="subMenu">
      ...
      {showSubMenu2 && (
        <div className="absolute top-1/2 left-1/2 bg-green-600 p-3 rounded transform -translate-x-1/2 -translate-y-1/2 text-center" id="subMenu2">
